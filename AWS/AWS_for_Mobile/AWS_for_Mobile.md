...
- Option2:
  ...
  - [CLI] Amplify CLI 설치 ![AWS CLI](AWS_for_Mobile.assets/setup_aws_cli.png)
...
1. Create a new React Native app 
   ...
   - Expo ![Expo](AWS_for_Mobile.assets/expo.png)

     ![image-20220618005551916](AWS_for_Mobile.assets/image-20220618005551916.png)

   - React Native CLI ![React Native CLI](AWS_for_Mobile.assets/react_native_cli.png)

2. Install Amplify libraries

   - Expo ![Expo-Amplify Libraries](AWS_for_Mobile.assets/expo_amplify_libraries.png)

   - React Native CLI ![React Native CLI-Amplify Libraries (1)](AWS_for_Mobile.assets/react_native_cli_amplify_libraries-1.png)
...
1. Create data model
   ...
   -  `To-do list` ,  `React Native` 선택 ➡ `Get started` 선택 ![image-20220618142601911](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\image-20220618142601911.png)

   - Add the isComplete Boolean field ![add field (1)](AWS_for_Mobile.assets/add_filed-1.png) 

     ![add field (2)](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\add_filed-2.png)

2. Generate the models locally
   - Install Amplify CLI to pull the data model
     - Amplify CLI 이미 설치 완료 `Skip`
     - 폴더로 이동 ➡ [CLI] 아래의 명령어 실행 ![pull amplify](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\pull_amplify.png "pull amplify") ![image-20220618183429325](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\image-20220618183429325.png)
     - 혹시 모를 상황에 대비하여 `sandboxId` 기록해두기
     - 다음 단계들도 `Skip`
     - `Deploy` 선택
     - `amplify/backend/api/amplifyDatasource/schema.graphql` 확인 ![graphql](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\graphql.png)
...
- Create a Home component for our app which will implement most of the CRUD functionality for our app
  ...
  - [CLI] Expo ![expo](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\expo_start.png)

    ![image-20220618200945957](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\image-20220618200945957.png)

    아직은 `Save Todo` 작동❌  ![image-20220618201043855](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\image-20220618201043855.png)

  - [CLI] React Native CLI on iOS ![ios](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\react_native_cli_ios.png)

  - [CLI] React Native CLI on Android ![android](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\react_native_cli_android.png)
...
- 결과 ![image-20220618201735000](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\image-20220618201735000.png) ![image-20220618201823195](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\image-20220618201823195.png)
...
1. Deploy your Amplify sandbox backend
   ...
   - Generate model files - 2. Generate the models locally 이어서
   ...
   - `Confirm deployment` 선택
     ...
     ![amplify studio](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\start_amplify_studio.png)

   - `Lauch Studio` 선택 ![lauch studio](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\lauch_studio.png)

2. Add authentication

   - 사이드바에서 `Authentication` 선택
   - 기본 설정 유지 ➡ 하단에 `Save and deploy` 선택
   - 배포 후, 상단에 `Deployment successful` 선택 ![](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\deploy_done.png)
   - 안내에 따라 최신 버전으로 `pull` ![amplify pull](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\amplify_pull.png)

3. Verifying cloud sync

   - 사이드바에서 `Content` 선택

   - Todo를 추가할 경우 `Content`에서 확인 가능 ![image-20220618212926975](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\image-20220618212926975.png)

   - 데이터 추가 ![Todo 추가](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\create_todo.png)

     ![Todo 추가](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\add_todo.png)

   - 결과 ![image-20220618213530700](C:\Users\NY\TIL\AWS\AWS_for_Mobile\AWS_for_Mobile.assets\image-20220618213530700.png)
